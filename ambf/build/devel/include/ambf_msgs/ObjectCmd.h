...
bool operator==(const ::ambf_msgs::ObjectCmd_<ContainerAllocator1> & lhs, const ::ambf_msgs::ObjectCmd_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.position_controller_mask == rhs.position_controller_mask &&
