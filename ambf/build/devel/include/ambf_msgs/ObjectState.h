...
bool operator==(const ::ambf_msgs::ObjectState_<ContainerAllocator1> & lhs, const ::ambf_msgs::ObjectState_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.userdata_description == rhs.userdata_description &&
