...
bool operator==(const ::ambf_msgs::WorldCmd_<ContainerAllocator1> & lhs, const ::ambf_msgs::WorldCmd_<ContainerAllocator2> & rhs)
{
  return lhs.enable_step_throttling == rhs.enable_step_throttling &&
    lhs.step_clock == rhs.step_clock &&
    lhs.n_skip_steps == rhs.n_skip_steps;
}
