...
class RigidBodyState {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float32(obj.joint_efforts, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RigidBodyState(null);
    ...
    data.joint_efforts = _arrayDeserializer.float32(buffer, bufferOffset, null)
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 4 * object.joint_efforts.length;
    return length + 212;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RigidBodyState(null);
