...
class ActuatorState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('actuated')) {
        this.actuated = initObj.actuated
      }
      else {
        this.actuated = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [actuated]
    bufferOffset = _serializer.bool(obj.actuated, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [actuated]
    data.actuated = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.actuated !== undefined) {
      resolved.actuated = msg.actuated;
    }
    else {
      resolved.actuated = false
    }
