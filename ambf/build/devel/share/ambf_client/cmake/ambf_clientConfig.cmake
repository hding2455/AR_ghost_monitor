...
if("TRUE" STREQUAL "TRUE")
  set(ambf_client_SOURCE_PREFIX /home/hding15/Desktop/ambf/ambf_ros_modules/ambf_client)
  set(ambf_client_DEVEL_PREFIX /home/hding15/Desktop/ambf/build/devel)
...
if(NOT "/home/hding15/Desktop/ambf/ambf_ros_modules/ambf_client/include " STREQUAL " ")
  set(ambf_client_INCLUDE_DIRS "")
  set(_include_dirs "/home/hding15/Desktop/ambf/ambf_ros_modules/ambf_client/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Shreyas Chandra Sekhar <schandrasekhar@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ambf_client' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hding15/Desktop/ambf/ambf_ros_modules/ambf_client/${idir}'.  ${_report}")
    endif()
