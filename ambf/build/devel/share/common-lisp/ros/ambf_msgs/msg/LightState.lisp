...
(cl:defmethod cl:initialize-instance :after ((m <LightState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LightState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ambf_msgs-msg:<LightState> is deprecated: use ambf_msgs-msg:LightState instead.")))
...
(cl:defmethod sim_step-val ((m <LightState>))
...
(cl:defmethod parent_name-val ((m <LightState>))
...
(cl:defmethod wall_time-val ((m <LightState>))
...
(cl:defmethod sim_time-val ((m <LightState>))
...
(cl:defmethod pose-val ((m <LightState>))
