...
psm_target_handle = _client.get_obj_handle('psm/maininsertionlink')
...
# mtm_wrist_handle = _client.get_obj_handle('mtm/WristRoll')
...
print(' ')
print('PSM Target fk')
print(psm_target_handle.get_pos())
print(psm_target_handle.get_rpy())
cur_pos = psm_target_handle.get_pos()
cur_rpy = psm_target_handle.get_rpy()
# print(' ')
...
raw_input("Control PSM tool positions. Press Enter to continue...")
for i in range(0, 500):
	psm_target_handle.pose_command(cur_pos.x, cur_pos.y, cur_pos.z+0.3*i/500, *cur_rpy)
